...
ae.math.Vector3D = class Vector3D {
	...
	addA(value: number): ae.math.Vector3D {
	...
	addB(v: ae.math.Vector3D): ae.math.Vector3D {
	...
	divA(value: number): ae.math.Vector3D {
	...
	divB(v: ae.math.Vector3D): ae.math.Vector3D {
	...
	multA(value: number): ae.math.Vector3D {
	...
	multB(v: ae.math.Vector3D): ae.math.Vector3D {
	...
	subA(value: number): ae.math.Vector3D {
	...
	subB(v: ae.math.Vector3D): ae.math.Vector3D {
