...
class AEClassPooledLinkedList<T> extends AEClassPooledCollection<T> {
	...
	_pp: {
		first: (ae.col.LinkedListNode | null);
		last:  (ae.col.LinkedListNode | null);
	}
	
	// private getters + setters ///////////////////////////////////////////////
	
	get _first(): (ae.col.LinkedListNode | null) {return this._pp.first;}
	get _last (): (ae.col.LinkedListNode | null) {return this._pp.last;}
	...
	_remove(node: (ae.col.LinkedListNode | null)): boolean {
