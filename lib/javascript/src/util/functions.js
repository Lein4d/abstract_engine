...
ae.util.cloneArray2D = function cloneArray2D<T>(
...
ae.util.cloneArray3D = function cloneArray3D<T>(
...
ae.util.create2DimArray = function create2DimArray<T>(
		dimSize1: number,
...
ae.util.create3DimArray = function create3DimArray<T>(
		dimSize1: number,
		dimSize2: number,
