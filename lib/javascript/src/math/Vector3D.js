...
ae.math.Vector3D = class Vector3D {
	...
	addA(v: ae.math.Vector3D): ae.math.Vector3D {
	...
	addB(value: number): ae.math.Vector3D {
	...
	divA(v: ae.math.Vector3D): ae.math.Vector3D {
	...
	divB(value: number): ae.math.Vector3D {
	...
	multA(v: ae.math.Vector3D): ae.math.Vector3D {
	...
	multB(value: number): ae.math.Vector3D {
	...
	subA(v: ae.math.Vector3D): ae.math.Vector3D {
	...
	subB(value: number): ae.math.Vector3D {
