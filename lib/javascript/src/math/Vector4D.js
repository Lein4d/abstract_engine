...
ae.math.Vector4D = class Vector4D {
	...
	addA(v: ae.math.Vector4D): ae.math.Vector4D {
	...
	addB(value: number): ae.math.Vector4D {
	...
	divA(v: ae.math.Vector4D): ae.math.Vector4D {
	...
	divB(value: number): ae.math.Vector4D {
	...
	multA(v: ae.math.Vector4D): ae.math.Vector4D {
	...
	multB(value: number): ae.math.Vector4D {
	...
	setDataD(
		...
		this.backend.x = x; this.backend.y = y;
		this.backend.z = z; this.backend.w = w;
		
		return this;
	}
	
	subA(v: ae.math.Vector4D): ae.math.Vector4D {
	...
	subB(value: number): ae.math.Vector4D {
